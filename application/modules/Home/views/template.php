...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo base_url() . 'assets_login/' ?>images/logo.png" />
  <title>Snap Pijat</title>
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a class="site_title"><i class="fa fa-book"></i> <span>SNAP PIJAT</span></a>
          </div>
          ...
          <div class="profile">
            <div class="profile_pic">
              <img src="<?php echo base_url() . 'assets_login/' ?>images/logo.png" alt="..." class="img-circle profile_img">
            </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <?php if ($level == 1) { ?>
                  <li><a><i class="fa fa-book"></i> Master <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li class="<?php if (isset($MsCabang)) {
                                    echo 'active';
                                  } ?>"><a href="<?php echo base_url('MsCabang') ?>">Cabang</a></li>
                      ...
                      <li class="<?php if (isset($MsPaket)) {
                                    echo 'active';
                                  } ?>"><a href="<?php echo base_url('MsPaket') ?>">Paket</a></li>
                      <li class="<?php if (isset($user)) {
                                    echo 'active';
                                  } ?>"><a href="<?php echo base_url('Users') ?>">User</a></li>
                    </ul>
                  </li>
                <?php } else { ?>
                  <li><a><i class="fa fa-book"></i> Master <span class="fa fa-chevron-down"></span></a>
                ...
                <li class="<?php if (isset($Pos)) {
                              echo 'active';
                            } ?>"><a href="<?php echo base_url('Pos') ?>"><i class="fa fa-edit"></i>Transaksi</a></li>
                <?php if ($level == 1) { ?>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                ...
                <ul class="dropdown-menu dropdown-usermenu pull-right">
                  <li><a href="<?php echo base_url('Users/ubahPswd') ?>"> Ubah Password</a></li>
