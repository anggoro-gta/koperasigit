        ...
        <div class="x_panel">
            ...
            <form class="form-horizontal form-label-left" autocomplete="off">
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-6 col-sm-4 col-xs-12">
                        <div class="input-group">
                            <input type="text" name="nama" required class="form-control col-md-7 col-xs-12" value="">
                        </div>
                    </div>
                </div>
                <!-- <div class="form-group required">
...
<script type="text/javascript">
    ...
    function data() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url() ?>MscbAnggota/getListDetail",
            data: {
                skpd,
                // tgl_dari,
                // tgl_sampai
