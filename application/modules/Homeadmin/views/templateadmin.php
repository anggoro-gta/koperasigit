            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a class="site_title"><i class="fa fa-book"></i> <span>KKPRI. CB</span></a>
                    </div>
                                ...
                                <li><a><i class="fa fa-book"></i> Master <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li class="<?php if (isset($MsKategoriPenerimaan)) {
                                                ...
                                                href="<?php echo base_url('MsKategori/Penerimaan') ?>">Kategori
                                                Penerimaan</a></li>
                                        <li class="<?php if (isset($MsKategoriPengeluaran)) {
                                                            echo 'active';
                                                        } ?>"><a
                      ...
                      <li class="<?php if (isset($Pos)) {
                                ...
                                <li><a><i class="fa fa-bar-chart"></i> Laporan <span
                                    ...
                                    <ul class="nav child_menu">
                                        <li class="<?php if (isset($lapTransaksi)) {
                                                            echo 'active';
                                                        } ?>"><a href="<?php echo base_url('Laporan/tunggakan') ?>">Lap
                                                Tunggakan</a></li>
                                        <li class="<?php if (isset($lapPinjaman)) {
                                                            echo 'active';
                                                        } ?>"><a href="<?php echo base_url('Laporan/pinjaman') ?>">Lap
                                                Pinjaman</a></li>
                                        <li class="<?php if (isset($lapSimpanan)) {
                                                            echo 'active';
                                                        } ?>"><a href="<?php echo base_url('Laporan/simpanan') ?>">Lap
                                                Simpanan</a></li>
                                        <li class="<?php if (isset($lapUpdateAnggota)) {
                                                            echo 'active';
                                                        } ?>"><a
                                                href="<?php echo base_url('Laporan/updateanggota') ?>">Lap Update
                                                Anggota</a></li>
                                        <li class="<?php if (isset($lapKompensasi)) {
                                                            echo 'active';
                                                        } ?>"><a
                                                href="<?php echo base_url('Laporan/kompensasi') ?>">Lap Kompensasi</a>
                                        </li>
                                        <li class="<?php if (isset($lapPelunasan)) {
                                                            echo 'active';
                                                        } ?>"><a href="<?php echo base_url('Laporan/pelunasan') ?>">Lap
                                                Pelunasan</a></li>
                                        <li class="<?php if (isset($lapSimpbln)) {
                                                            echo 'active';
                                                        } ?>"><a href="<?php echo base_url('Laporan/simpnbln') ?>">Lap
                                                Simpanan Bulanan</a>
                                        </li>
                                        ...
                                        <li class="<?php if (isset($lapSimpThnOpd)) {
                                                            echo 'active';
                                                        } ?>"><a
                                                href="<?php echo base_url('Laporan/simpnthnopd') ?>">Lap
                                                Simp thn per OPD</a>
                                        </li>
                                        ...
                                        <li class="<?php if (isset($lapPentagbln)) {
                                                            echo 'active';
                                                        } ?>"><a href="<?php echo base_url('Laporan/pentagbln') ?>">Lap
                                                Pentag Bulanan</a>
                                        </li>
                                        <li class="<?php if (isset($lapPentagthn)) {
                                                            echo 'active';
                                                        } ?>"><a href="<?php echo base_url('Laporan/pentagthn') ?>">Lap
                                                Pentag Tahunan</a>
                                        </li>
                                ...
                                <li><a><i class="fa fa-edit"></i> SHU <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li class="<?php if (isset($variabelnya)) {
                                                            echo 'active';
                                                        } ?>"><a href="<?php echo base_url('SHU/Total') ?>">Total</a>
                                        </li>
                                        <li class="<?php if (isset($variabelnya)) {
                                                            echo 'active';
