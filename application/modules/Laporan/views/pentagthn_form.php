              ...
              <div class="x_content">
                <br />
                  ...
                  <div class="form-group required">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Pilih Tahun</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" name="periode" required class="form-control col-md-7 col-xs-12 tahun">
                    </div>
                  </div>
