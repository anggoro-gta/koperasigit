      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <form action="<?= $action; ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" autocomplete='off'>
            ...
            <div class="form-group required">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nama SKPD</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="nama_skpd" required class="form-control col-md-7 col-xs-12" value="<?= $nama_skpd ?>">
              </div>
            </div>
