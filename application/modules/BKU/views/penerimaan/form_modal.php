...
<input type="hidden" name="fk_id_ms_kategori_penerimaan" value="<?= $id_kategori ?>">

<div class="alert alert-info">
    <b>Kategori:</b> <?= htmlspecialchars($kategori->nama_kategori_penerimaan, ENT_QUOTES, 'UTF-8') ?><br>
