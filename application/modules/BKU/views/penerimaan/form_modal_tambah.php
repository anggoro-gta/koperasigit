...
<input type="hidden" name="id_bku_penerimaan" value="">
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <select class="form-control input-sm no-select2" name="kategori" required>
                ...
                ?>
                <option value="<?= $k->id ?>"><?= $k->nama_kategori_penerimaan ?></option>
                <?php
                    }
                ?>
            </select>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="angsuran_pokok" class="form-control input-sm text-right input-rupiah" value="">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="angsuran_bunga" class="form-control input-sm text-right input-rupiah" value="">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="angsuran_barang" class="form-control input-sm text-right input-rupiah" value="">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="penjualan_tunai" class="form-control input-sm text-right input-rupiah" value="">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label>Bank</label>
            <input type="text" name="bank" class="form-control input-sm text-right input-rupiah" value="">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="foto_copy" class="form-control input-sm text-right input-rupiah" value="">
        </div>
    </div>
