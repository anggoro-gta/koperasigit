        ...
        <div class="x_content">
          ...
          <form action="<?= $action; ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" autocomplete='off'>
            ...
            <div class="form-group required">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="username" required class="form-control col-md-7 col-xs-12" value="<?= $username ?>">
              </div>
            </div>
            <div class="form-group required">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nama Lengkap</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="nama_lengkap" required class="form-control col-md-7 col-xs-12" value="<?= $nama_lengkap ?>">
              </div>
            </div>
            <div class="form-group required">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Level</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" name="fk_cb_level_id" id="fk_cb_level_id" required>
                  <option value="">.: Pilih :.</option>
                  <?php foreach ($arrLevel as $val) { ?>
                    <option <?= $fk_cb_level_id == $val['id'] ? 'selected' : '' ?> value="<?= $val['id'] ?>"><?= $val['nama'] ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            <div class="form-group required">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Status Blokir</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <label class="radio-inline">
                  <input id="inlineRadio2" name="blokir" value="N" type="radio" <?php echo $blokir == 'N' ? 'checked' : ''; ?>>
                  No
                </label>
              </div>
            </div>
