...
class Pinjaman extends CI_Controller
{
	...
	public function create()
	{
		...
		$data['arrUserAnggota'] = $this->db->query("SELECT a.id,a.nama,s.nama_skpd FROM ms_cb_user_anggota a INNER JOIN ms_cb_skpd s ON s.id=a.fk_id_skpd WHERE a.status_keaktifan = 'aktif'")->result_array();
