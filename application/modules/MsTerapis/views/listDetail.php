                        ...
                        <table class="table table-bordered table-striped" id="example2" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <!-- <th><center>Nama Panggilan</center></th> -->
                                    <th><center>No HP</center></th>
                                    <th><center>Tgl Bergabung</center></th>
                                    <th><center>Alamat</center></th>
                                    <!-- <th><center>Fee (%)</center></th> -->
                                    <th><center>Jml Pijat</center></th>
...
$(document).ready(function() {
    var t = $("#example2").dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url()?>MsTerapis/getDatatables", "type": "POST",
            "data": {"fk_cabang_id": "<?=$fk_cabang_id?>"}
        },
        columns: [
            {
                "data": "id",
