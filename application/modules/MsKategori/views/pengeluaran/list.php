...
<div class="modal fade" id="modalMigrasi" tabindex="-1" role="dialog" aria-labelledby="modalMigrasiLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formMigrasi" method="post" action="<?= base_url('MsKategori/Pengeluaran/migrasi_action') ?>">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <h4 class="modal-title" id="modalMigrasiLabel">
                        Migrasi Kategori Pengeluaran
                    </h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <hr>
                    <p class="text-danger">
                        NB : Data kategori pengeluaran dari tahun referensi akan disalin ke tahun tujuan.
...
$(document).ready(function() {
    var t = $("#example2").DataTable({
        ...
        "pageLength": 100,
        ajax: {
            "url": "<?= base_url()?>MsKategori/Pengeluaran/getDatatables",
            "type": "POST",
            data: function(d) {
                d.tahun = $('#tahun').val();
            }
...
function reloadTahunMigrasi(selectedValue = '') {
    $.ajax({
        url: "<?= base_url('MsKategori/Pengeluaran/get_tahun_migrasi') ?>",
        type: "GET",
        dataType: "json",
        success: function(res) {
            if (res.status == 'success') {
