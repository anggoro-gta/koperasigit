                ...
                <tbody>
                    <tr>
                        ...
                        <input type="hidden" name="jml_tagihan" id="jml_tagihan"
                            value="<?= number_format($pinjaman->jml_tagihan)  ?>">
                        <input type="hidden" id="min_angsuran" value="<?= $pinjaman->angsuran_ke ?>">
                        <input type="hidden" id="max_angsuran" value="<?= $pinjaman->tenor ?>">
                        <input type="hidden" id="sisa_angsuran"
                            value="<?= $pinjaman->tenor - $pinjaman->jml_angsuran ?>">
                        <input type="hidden" id="const_pokok"
                            value="<?= number_format($pinjaman->pokok, 0, ",", "")  ?>">
                        <input type="hidden" id="const_tapim"
                            value="<?= number_format($pinjaman->tapim, 0, ",", "")  ?>">
                        <input type="hidden" id="const_bunga"
                            value="<?= number_format($pinjaman->bunga, 0, ",", "")  ?>">
                        <input type="hidden" id="const_jml_tagihan"
                            value="<?= number_format($pinjaman->jml_tagihan, 0, ",", "")  ?>">
                        <td scope="row">1</td>
                        <td><?= $pinjaman->tgl ?></td>
                        ...
                        <?php } else { ?>
                        <td><input <?= $jenis == 4 || $jenis == 5 ? 'readonly' : '' ?> type="text" name="angsuran_ke"
                                class="form-control" id="angsuran_ke" value="<?= $pinjaman->angsuran_ke ?>"></td>
                        <?php } ?>
                        ...
                        <?php
                                    ...
                                    ?>
                        <td><input type="text" name="label_tapim" id="label_tapim" class="form-control nominal"
                                value="<?= $result_tapim ?>"></td>
                        <td><input type="text" name="label_bunga" id="label_bunga" class="form-control nominal"
                                value="<?= $result_bunga/2 ?>"></td>
                        <?php } else { ?>
                        ...
                        <td>
                            <div class="btn-group text-center"><a class="btn btn-xs btn-danger"
                                    ...
                                    href="<?php echo base_url() ?>/Tagihan/delete_pinjaman/<?= $pinjaman->id ?>/<?= $pinjaman->fk_tagihan_id ?>"><i
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group text-center"><a class="btn btn-xs btn-danger"
                                    onclick="return confirm('Apakah Anda akan menghapus data?');"
                                    href="<?php echo base_url() ?>/Tagihan/delete_simpanan/<?= $simpanan->id ?>/<?= $simpanan->fk_tagihan_id ?>"><i
                                        class="fa fa-trash"></i></a></div>
                        </td>
                        <?php } ?>
                    </tr>
