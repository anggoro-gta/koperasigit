...
class Tagihan extends CI_Controller
{
	...
	public function getListDetail()
	{
		...
		$this->load->view('Simpanan/listDetail', $data);
	}
	...
	public function getDatatables()
	{
		...
		$this->datatables->from("v_simpanan_new	");
	...
	{
		$que = "SELECT s.*,mk.nama_skpd FROM t_cb_simpanan s INNER JOIN ms_cb_skpd mk ON mk.id=s.fk_skpd_id WHERE fk_anggota_id='$id' ORDER BY s.tgl DESC";
		$data['hasil'] = $this->db->query($que)->result();

		$this->template->load('Homeadmin/templateadmin', 'Simpanan/viewRiwayat', $data);
	}
}
